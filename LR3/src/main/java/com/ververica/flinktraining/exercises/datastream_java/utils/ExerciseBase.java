...
public class ExerciseBase {
	...
	public final static String pathToRideData = "src/main/resources/nycTaxiRides.gz";
	public final static String pathToFareData = "src/main/resources/nycTaxiFares.gz";
