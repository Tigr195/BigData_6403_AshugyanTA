...
public class HourlyTipsExercise extends ExerciseBase {
	...
	public static void main(String[] args) throws Exception {
		...
		fares
				...
				.process(new com.ververica.flinktraining.solutions.datastream_java.windows.HourlyTipsSolution.AddTips())
		...
		DataStream<Tuple3<Long, Long, Float>> hourlyTips = fares
				...
				.window(TumblingEventTimeWindows.of(Time.hours(1))) // Окно в 1 час
				.process(new com.ververica.flinktraining.solutions.datastream_java.windows.HourlyTipsSolution.AddTips()); // Используем ваш готовый класс AddTips

// 2. Находим максимальную сумму среди всех водителей в каждом часовом окне
		DataStream<Tuple3<Long, Long, Float>> hourlyMax = hourlyTips
				.windowAll(TumblingEventTimeWindows.of(Time.hours(1))) // Смотрим на всех водителей сразу
				.maxBy(2); // Выбираем кортеж с максимальным значением в поле f2 (сумма чаевых)

// Печатаем результат или передаем в тест
